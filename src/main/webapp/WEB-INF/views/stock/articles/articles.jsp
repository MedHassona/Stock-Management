        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/articles/nouveau" />" ><i class="fa fa-plus">&nbsp;ajouter</i></a></li>
						  <li><a href="<c:url value="/articles/export" />" ><i class="fa fa-download">&nbsp;exporter</i></a></li>
                                ...
                                <tbody>
                                	<c:forEach items="${arts }" var="art">
                                		<tr class="gradeA odd" role="row">
	                                        <td ><c:out value="${art.getCodeArticle() }"/></td>
	                                        <td><c:out value="${art.getNomArticle() }"/></td>
	                                        <td><c:out value="${art.getCategorie().getNomCategory() }"/></td>
	                                        <td><c:out value="${art.getQteStock() }"/></td>
	                                        <td ><c:out value="${art.getDescription() }"/></td>
	                                        <td class="center">
                                        		<c:url value="/articles/modifier" var="modifier" />
                                        		<a href="${modifier }?id=${art.getIdArticle() }"  ><i class="fa fa-edit"></i></a>
                                        		&nbsp;|&nbsp;
						                            <!-- Button trigger modal -->
						                            <a href="javascript:void(0);" data-toggle="modal" data-target="#modalArticle${ art.getIdArticle() }"><i class="fa fa-trash-o" ></i></a>
						                            <!-- Modal -->
						                            <div class="modal fade" id="modalArticle${ art.getIdArticle() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						                                <div class="modal-dialog">
						                                    <div class="modal-content">
						                                        ...
						                                        <div class="modal-footer">
						                                            ...
						                                            <c:url value="/articles/supprimer" var="supprimer"/>
						                                            <a href="${supprimer }?id=${art.getIdArticle() }" type="button" class="btn btn-danger"><i class="fa fa-trash-o" ></i>&nbsp;Confirmer</a>
						                                        </div>
						                                    </div>
						                                    <!-- /.modal-content -->
						                                </div>
