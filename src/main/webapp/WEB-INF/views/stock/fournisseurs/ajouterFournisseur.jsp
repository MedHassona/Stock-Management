...
<head>
    ...
    <title>Stock - Nouveau Fournisseur</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                        	  <c:url value="/fournisseurs/nouveau" var="enrgistrer" />
                              <f:form modelAttribute="fournisseur" action="${enrgistrer }" role="form">
                                 <f:hidden path="id"/>
                              	 <div class="form-group">
                                      <label>Nom</label>
                                      <f:input path="nom" class="form-control" placeholder="nom du fournisseur"/>
                                  </div>	 <div class="form-group">
                                      <label>Preom</label>
                                      <f:input path="prenom" class="form-control" placeholder="prenom du fournisseur"/>
                                  </div>
                                  	 <div class="form-group">
                                      <label>Ville</label>
                                  ...
                                  <div class="panel-footer">
                                  	  ...
                                  	  <a href="<c:url value="/fournisseurs/"/>" class="btn btn-danger"><li class="fa fa-arrow-left">&nbsp;Annuler</li></a>
                                  </div>
                              </f:form>
                        </div>
                        <!-- /.panel-body -->
