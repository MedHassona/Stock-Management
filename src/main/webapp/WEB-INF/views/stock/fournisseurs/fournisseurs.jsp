...
<head>
    ...
    <title>Stock - Fournisseurs</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Les Fournisseurs</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/fournisseurs/nouveau" />" ><i class="fa fa-plus">&nbsp;ajouter</i></a></li>
	                    ...
	                    <div class="panel panel-primary">
	                        ...
	                        <div class="panel-body">
	                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
	                                ...
	                                <tbody>
	                                	<c:forEach var="fournisseur" items="${fours }">
	                                		<tr class="gradeA odd" role="row">
			                           		 	<td><c:out value="${fournisseur.getNom()}" /></td>
		                                        <td><c:out value="${fournisseur.getPrenom() }" /></td>
		                                        <td><c:out value="${fournisseur.getVille() }" /></td>
		                                        <td><c:out value="${fournisseur.getAdress()}" /></td>
		                                        <td><c:out value="${fournisseur.getTel()}" /></td>
		                                        <td class="center">
	                                        	<c:url value="/fournisseurs/modifier" var="modifier" />
	                                        	<a href="${modifier }?id=${fournisseur.getId()}" ><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<!-- Button trigger modal -->
						                      	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalFournisseur${ fournisseur.getId() }"><i class="fa fa-trash-o" ></i></a>
						                            <!-- Modal -->
						                            <div class="modal fade" id="modalFournisseur${ fournisseur.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						                                <div class="modal-dialog">
						                                    <div class="modal-content">
						                                        ...
						                                        <div class="modal-footer">
						                                            ...
						                                            <c:url value="/fournisseurs/supprimer" var="supprimer"/>
						                                            <a href="${supprimer }?id=${ fournisseur.getId() }" type="button" class="btn btn-danger"><i class="fa fa-trash-o" ></i>&nbsp;Confirmer</a>
						                                        </div>
						                                    </div>
						                                    <!-- /.modal-content -->
						                                </div>
