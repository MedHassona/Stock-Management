            ...
            <div class="container-fluid">
                <div class="row">
	        	  ...
	        	  <div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
							  <li><a href="<c:url value="/divisions/nouveau" />" ><i class="fa fa-plus">&nbsp;ajouter</i></a></li>
	                        ...
	                        <div class="panel-body">
	                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
	                                ...
	                                <c:forEach items="${divs}" var="division">
	                                   <tr class="odd gradeX">
	                                        <td><c:out value="${division.getNomDivision() }" /></td>

	                                        <td class="center">
	                                        	<c:url value="/division/modifier" var="modifier" />
	                                        	<a href="${modifier}?id=${division.getNomDivision()}" ><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<!-- Button trigger modal -->
							                      <a href="javascript:void(0);" data-toggle="modal" data-target="#modalDivision${division.getNomDivision()}"><i class="fa fa-trash-o" ></i></a>
							                            <!-- Modal -->
							                            <div class="modal fade" id="modalDivision${division.getNomDivision()}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
							                                <div class="modal-dialog">
							                                    <div class="modal-content">
							                                        ...
							                                        <div class="modal-body">
							                                            Voulez-vous supprimer cet Division ?
							                                        </div>
							                                        <div class="modal-footer">
							                                            <button type="button" class="btn btn-primary" data-dismiss="modal">Annuler</button>
							                                            <c:url value="/divisions/supprimer" var="supprimer"/>
							                                            <a href="${supprimer }?nom=${division.getNomDivision() }" type="button" class="btn btn-danger"><i class="fa fa-trash-o" ></i>&nbsp;Confirmer</a>
							                                        </div>
							                                    </div>
							                                    <!-- /.modal-content -->
							                                </div>
