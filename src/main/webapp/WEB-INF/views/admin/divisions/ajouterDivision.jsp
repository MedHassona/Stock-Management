    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nouvelle Division</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
	                        ...
	                        <div class="panel-body">
	                        	  <c:url value="/divisions/nouveau" var="enrgistrer" />
	                              <f:form modelAttribute="division"  action="${enrgistrer }" role="form">
	                              	 <div class="form-group">
	                                      <label>Nom de la Division</label>
	                                      <f:input path="nomDivision" class="form-control" placeholder="nom de la nouvelle division"/>
	                                  </div> 
	                                  <div class="panel-footer">
		                                  	  <button type="submit" class="btn btn-primary"><li class="fa fa-save">&nbsp;Enrgistrer</li></button>
		                                  	  <a href="<c:url value="/divisions/"/>" class="btn btn-danger"><li class="fa fa-arrow-left">&nbsp;Annuler</li></a>
		                              </div>
	                              </f:form>
	                        </div>
	                        <!-- /.panel-body -->
