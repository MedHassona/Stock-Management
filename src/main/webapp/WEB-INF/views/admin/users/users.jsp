...
<head>
    ...
    <title>Stock - Utilisateurs</title>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/users/nouveau" />" ><i class="fa fa-plus">&nbsp;ajouter</i></a></li>
	                                ...
	                                <tbody>
	                                	<c:forEach var="agent" items="${agents }">
	                                		<tr class="gradeA odd" role="row">
		                                        ...
		                                        <td><c:out value="${agent.getAdress() }" /></td>
		                                        <td><c:out value="${agent.getTel()}" /></td>
		                                        <td><c:out value="${agent.getMail()}" /></td>
		                                        <td><c:out value="${agent.getRole()}" /></td>
		                                        <td class="center">
	                                        	<c:url value="/fournisseurs/modifier" var="modifier" />
	                                        	<a href="${modifier }?id=${agent.getUsername()}" ><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<!-- Button trigger modal -->
						                      	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalFournisseur${ agent.getUsername() }"><i class="fa fa-trash-o" ></i></a>
						                            <!-- Modal -->
						                            <div class="modal fade" id="modalFournisseur${ agent.getUsername() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						                                <div class="modal-dialog">
						                                    <div class="modal-content">
						                                        ...
						                                        <div class="modal-footer">
						                                            ...
						                                            <a href="${supprimer }?id=${ agent.getUsername() }" type="button" class="btn btn-danger"><i class="fa fa-trash-o" ></i>&nbsp;Confirmer</a>
						                                        </div>
						                                    </div>
						                                    <!-- /.modal-content -->
						                                </div>
