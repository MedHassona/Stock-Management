    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color:red;">Réfusé :/</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="col-lg-12">
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body" style="color:red;">
                            <h3>vous n'avez pas le droit d'acceder à cette page !</h3>
                            <p>vous pouvez contacter la direction pour plus d'informations.</p>
                        </div>
                    </div>
                    <!-- /.col-lg-4 -->
                </div>
